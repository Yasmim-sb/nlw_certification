INSERT INTO questions (id, technology, description) VALUES
('c5f02721-6dc3-4fa6-b46d-6f2e8dca9c66',  'JAVA','Como criar uma classe em Java?'),
('b0ec9e6b-721c-43c7-9432-4d0b6eb15b01', 'JAVA','Explique o conceito de polimorfismo em Java.'),
('f85e9434-1711-4e02-9f9e-7831aa5c743a', 'JAVA','Como lidar com exceções em Java?');
